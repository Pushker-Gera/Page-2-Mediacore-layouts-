            ...
            <div className="card-1">
              ...
              <div className="comments-box">
                <p className='para-19' onClick={() => {
                  ...
                  <svg className='svg-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.5 4C4.4625 4 2 6.4625 2 9.5C2 15 8.5 20 12 21.163C15.5 20 22 15 22 9.5C22 6.4625 19.5375 4 16.5 4C14.64 4 12.995 4.9235 12 6.337C11.4928 5.6146 10.8191 5.02505 10.0358 4.61824C9.25245 4.21144 8.38265 3.99938 7.5 4Z"
                      stroke={liked[1] ? "red" : "black"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg> {likes[1]}
                </p>
            ...
            <div className="card-1">
              ...
              <div className="comments-box">
                <p className='para-19' onClick={() => {
                  ...
                  <svg className='svg-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.5 4C4.4625 4 2 6.4625 2 9.5C2 15 8.5 20 12 21.163C15.5 20 22 15 22 9.5C22 6.4625 19.5375 4 16.5 4C14.64 4 12.995 4.9235 12 6.337C11.4928 5.6146 10.8191 5.02505 10.0358 4.61824C9.25245 4.21144 8.38265 3.99938 7.5 4Z"
                      stroke={liked[2] ? "red" : "black"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg> {likes[2]}
                </p>
            ...
            <div className="card-1">
              ...
              <div className="comments-box">
                <p className='para-19' onClick={() => {
                  ...
                  <svg className='svg-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.5 4C4.4625 4 2 6.4625 2 9.5C2 15 8.5 20 12 21.163C15.5 20 22 15 22 9.5C22 6.4625 19.5375 4 16.5 4C14.64 4 12.995 4.9235 12 6.337C11.4928 5.6146 10.8191 5.02505 10.0358 4.61824C9.25245 4.21144 8.38265 3.99938 7.5 4Z"
                      stroke={liked[3] ? "red" : "black"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg> {likes[3]}
                </p>
            ...
            <div className="card-1">
              ...
              <div className="comments-box">
                <p className='para-19' onClick={() => {
                  ...
                  <svg className='svg-2' width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M7.5 4C4.4625 4 2 6.4625 2 9.5C2 15 8.5 20 12 21.163C15.5 20 22 15 22 9.5C22 6.4625 19.5375 4 16.5 4C14.64 4 12.995 4.9235 12 6.337C11.4928 5.6146 10.8191 5.02505 10.0358 4.61824C9.25245 4.21144 8.38265 3.99938 7.5 4Z"
                      stroke={liked[4] ? "red" : "black"} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                  </svg> {likes[4]}
                </p>
